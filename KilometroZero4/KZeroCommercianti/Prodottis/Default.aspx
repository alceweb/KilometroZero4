<%@ Page Title="ProdottiList" Language="C#" MasterPageFile="~/Site.Master" CodeBehind="Default.aspx.cs" Inherits="KilometroZero4.KZeroCommercianti.Prodottis.Default" %>
<%@ Register TagPrefix="FriendlyUrls" Namespace="Microsoft.AspNet.FriendlyUrls" %>
<asp:Content runat="server" ContentPlaceHolderID="MainContent">
    <h2>Prodottis List</h2>
    <p>
        <asp:HyperLink runat="server" NavigateUrl="Insert" Text="Aggiungi un prodotto" />
    </p>
    <div>
        <asp:ListView id="ListView1" runat="server"
            ...
            <ItemTemplate>
                <tr>
                    ...
                    <td>
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/KZeroCommercianti/Prodottis/Details", Item.prodottoId) %>' Text="Details" /> | 
					    <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/KZeroCommercianti/Prodottis/Edit", Item.prodottoId) %>' Text="Edit" /> | 
                        <asp:HyperLink runat="server" NavigateUrl='<%# FriendlyUrl.Href("~/KZeroCommercianti/Prodottis/Delete", Item.prodottoId) %>' Text="Delete" />
                    </td>
                </tr>
            </ItemTemplate>
        </asp:ListView>
